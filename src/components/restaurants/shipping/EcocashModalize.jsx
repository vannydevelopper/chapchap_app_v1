...
export default function EcocashModalize (){
        ...
        return(
                ...
                //     /> :
                              <View style={styles.container}>
                                        ...
                                        <TouchableOpacity style={[styles.payBtn, !isValidate() && { opacity: 0.5 }]} disabled={!isValidate()} >
                                                  <Text style={styles.payBtnTitle}>PAYER </Text>
                                        </TouchableOpacity>
                              </View>
        )
}
