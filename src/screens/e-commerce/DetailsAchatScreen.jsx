...
import { Image, View, StyleSheet, Text, TouchableOpacity, TouchableNativeFeedback, TextInput, ScrollView } from "react-native"
...
export default function DetailAchatScreen() {
        ...
        return (
                <>
                        <View style={{ marginTop: 30, marginHorizontal: 10, flex: 1 }}>
