                        ...
                        <View style={styles.cardOrginal}>
                                ...
                                <View style={{ justifyContent: "space-between", flexDirection: "row" }}>
                                        <View style={{alignContent:"center", alignItems:"center"}}>
                                                ...
                                                <Text style={{ fontSize: 12, fontWeight: "bold" }}>Vetements</Text>
                                        </View>
                                        <View style={{alignContent:"center", alignItems:"center"}}>
                                                <View style={styles.cardPhoto1}>
                                                        <MaterialCommunityIcons name="shoe-sneaker" size={30} color="black" />
                                                </View>
                                                <Text style={{ fontSize: 12, fontWeight: "bold" }}>Chaussures</Text>
                                        </View>
                                        <View style={{alignContent:"center", alignItems:"center"}}>
                                                <View style={styles.cardPhoto1}>
                                                        <FontAwesome name="television" size={24} color="black" />
                                                </View>
                                                <Text style={{ fontSize: 12, fontWeight: "bold" }}>Electroniques</Text>
                                        </View>
                                        <View style={{alignContent:"center", alignItems:"center"}}>
                                                <View style={styles.cardPhoto1}>
                                                        <FontAwesome name="assistive-listening-systems" size={24} color="black" />
                                                </View>
                                                <Text style={{ fontSize: 12, fontWeight: "bold" }}>Casmetiques</Text>
                                        </View>
                                </View>
