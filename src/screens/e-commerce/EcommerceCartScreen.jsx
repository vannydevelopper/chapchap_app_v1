...
export default function EcommerceCartScreen() {
      ...
      var productParPartenaire = {}
      const partenaireProducts = []
      products.forEach(product => {
            if (productParPartenaire[product.produit_partenaire.ID_PARTENAIRE_SERVICE]) {
                  productParPartenaire[product.produit_partenaire.ID_PARTENAIRE_SERVICE].push(product)
            }
            else {
