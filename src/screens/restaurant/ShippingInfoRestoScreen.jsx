...
export default function ShippingInfoRestoScreen() {
                ...
                <View style={styles.container}>
                        <ScrollView keyboardShouldPersistTap="handled">
                                ...
                                <View style={styles.navigation}>
                                        ...
                                        <TouchableNativeFeedback useForeground disabled={!isValidate()} onPress={() => navigation.navigate('PaymentRestoScreen')}>
