...
import EcocashModalize from '../../components/restaurants/shipping/EcocashModalize';

export default function PaymentRestoScreen() {
        const METHODS = [{
                id: 1,
                name: "ECOCASH",
                available: true,
        ...
        return (
                ...
                <Portal>
                          <GestureHandlerRootView style={{ height: isOpen ? '100%' : 0, opacity: isOpen ? 1 : 0, backgroundColor: 'rgba(0, 0, 0, 0)', position: 'absolute', width: '100%', zIndex: 1 }}>
                                    ...
                                    >
                                              <EcocashModalize info={METHODS[0]} loadingForm={loadingForm} onClose={onCloseModalize} onFInish={onEcocashFinish} />
                                    </Modalize>
